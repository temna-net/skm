...
if(!submitcheck('topicsubmit', 0, $seccodecheck, $secqaacheck)) {
	...
	/*skm 板块预设内容 start*/
	$skm_sdefault = unserialize($_G['cache']['plugin']['sicau_pt_x2']['default_subject']);
	$postinfo['subject'] = $postinfo['subject'] ? $postinfo['subject'] : $skm_sdefault[$_G['fid']];
	
	$skm_cdefault = unserialize($_G['cache']['plugin']['sicau_pt_x2']['default_content']);
	$message = $message ? $message : $skm_cdefault[$_G['fid']];
	/*skm 板块预设内容 end*/
