...
<div class="qdsmile"><li><center>'.lang('plugin/dsu_paulsign','ta_mind').'</center><table><tr><th><img src="source/plugin/dsu_paulsign/img/'.$_G['cache']['plugin']['dsu_paulsign']['emottype'].'/'.$days[$postlist[$key][authorid]][qdxq].'.gif"><th><font size="5px">'.$days[$postlist[$key][authorid]][qdxqzw].'</font><br>'.$days[$postlist[$key][authorid]][time].'</tr></table></li></div>';
						...
						if($open == '2')$echoonce = '<div class="qdsmile"><li><center>'.lang('plugin/dsu_paulsign','ta_mind').'</center><table><tr><th><img src="source/plugin/dsu_paulsign/img/'.$_G['cache']['plugin']['dsu_paulsign']['emottype'].'/'.$days[$postlist[$key][authorid]][qdxq].'.gif"><th><font size="5px">'.$days[$postlist[$key][authorid]][qdxqzw].'</font><br>'.$days[$postlist[$key][authorid]][time].'</tr></table></li></div>';
						$echoonce .= '<p>'.lang('plugin/dsu_paulsign','classn_01').': '.$days[$postlist[$key][authorid]][days].' '.lang('plugin/dsu_paulsign','classn_02').'</p><p>'.$days[$postlist[$key][authorid]][level].'</p>';
					}
			} else {
				if($firstcycle == '1'){
