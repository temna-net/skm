...
EOB;
	...
	function editpost() {
				return <<<EOB
		<div style="border:dashed 4px #ccc;padding:10px 10px 10px 10px;margin-bottom:10px">
		<p>友情提醒：<span style="color:#F00;">你只能修改帖子描述哦！如果你上传了不合适的资源请联系版主删除</span>
	...
	function viewthread($tid) {
		...
		if($_G['uid']>0){
			...
			<span style="padding-left:10px;">
				<a href="http://www.utorrent.com/" target="_blank"><img title="请使用utorrent打开种子文件" src="source/plugin/sikemi/images/torrent.gif"align="absmiddle"></a>
				<a style="font-weight: bold;color:#09C" title="{$results['filename']}" href="plugin.php?id=sikemi:download&tid={$tid}">{$filename}</a>(13.08 KB)(<a href="plugin.php?id=sikemi:torr_info&tid={$tid}" style="color:#09C" onclick="showWindow('torrentinfo', this.href);return false;">查看种子详情</a>) 
