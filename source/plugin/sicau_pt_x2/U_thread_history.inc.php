...
if(empty($users)){
	...
	foreach($users as $v=>$uid){
		...
		$msg.="<a href='home.php?mod=space&uid={$uid}&do=profile' title='{$uid}' target='_blank'><img src='{$ucenter_url}avatar.php?uid={$uid}&size=small'/ style='padding-left:10px;padding-bottom:6px;float:left;'></a>";
	}
}
