...
<p class="mbn"><a href="home.php?mod=magic" target="_blank">回赠道具</a><span class="pipe">|</span><a href="home.php?mod=magic&action=mybox" target="_blank">查看我的道具箱</a></p>',
	'system_thread_validating' => '有需要您审核的帖子呢！，点开这里看看吧,<a href="forum.php?mod=modcp&action=moderate&op=threads&fid={fid} target="_blank"">现在进行审核</a></br><a href="home.php?mod=space&uid={uid}" target="_blank">{actor}</a>在{area}发表{subject}',
